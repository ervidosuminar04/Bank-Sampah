...
class MasterSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Sampah::create([
            'sampah_nama'       => 'Plastik PET (Botol/Gelas)',
        ...
        Sampah::create([
            'sampah_nama'       => 'Kertas Karton / Kardus',
            'sampah_jenis'      => 'Kertas',
            'sampah_satuan'     => 'kg',
        ...
        Sampah::create([
            'sampah_nama'       => 'Pecahan Kaca / Botol Kaca',
            'sampah_jenis'      => 'Kaca',
            'sampah_satuan'     => 'kg',
        ...
        Geolokasi::create([
            ...
            'geolokasi_alamat'=> 'Jl. Sudirman No. 23, Jakarta Pusat',
            'latitude'        => -6.1824,
            'longitude'       => 106.8294,
        ...
        Geolokasi::create([
            ...
            'geolokasi_alamat'=> 'Jl. Thamrin No. 45, Jakarta Pusat',
            'latitude'        => -6.1950,
            'longitude'       => 106.8320,
        ...
        Geolokasi::create([
            ...
            'geolokasi_alamat'=> 'Jl. Gajah Mada No. 12, Jakarta Barat',
            'latitude'        => -6.1685,
            'longitude'       => 106.8142,
